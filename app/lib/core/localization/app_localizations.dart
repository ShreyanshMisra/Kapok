  ...
  String _getString(String key) {
    final Map<String, Map<String, String>> localizedValues = {
      'en': {
        ...
        'keyFeaturesDescription': '• Real-time task management\n   and assignment\n• Team creation and\n   member coordination\n• Location-based\n   task mapping\n• Offline-first functionality\n   for remote areas\n• Bilingual support\n   (English and Spanish)\n• Role-based\n   access control\n• Secure authentication (end-to-end encrypted)\n   and data protection',
      ...
      'es': {
        ...
        'keyFeaturesDescription': '• Gestión de tareas en tiempo real\n   y asignación\n• Creación de equipos y\n   coordinación de miembros\n• Mapeo de tareas\n   basado en ubicación\n• Funcionalidad sin conexión\n   para áreas remotas\n• Soporte bilingüe\n   (Inglés y Español)\n• Control de acceso\n   basado en roles\n• Autenticación segura (cifrado de extremo a extremo)\n   y protección de datos',
